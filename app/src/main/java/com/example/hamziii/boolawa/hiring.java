    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListner = new FirebaseAuth.AuthStateListener()
        {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth)
            {
                ...
                {
                    Intent intent = new Intent(hiring.this, LoginActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id){
            case R.id.first_item:
                Intent h = new Intent(hiring.this,gallery.class);
                startActivity(h);
                break;
            case R.id.second_item:
                Intent n = new Intent(hiring.this,tools.class);
                startActivity(n);
                break;
            case R.id.third_item:
                Intent z = new Intent(hiring.this,slideshow.class);
                startActivity(z);
                break;
            case R.id.signout:
                maAuth.signOut();
