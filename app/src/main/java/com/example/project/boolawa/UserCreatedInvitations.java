...
public class UserCreatedInvitations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_created_invitations);
        ...
        mcreatedEvent_list = (RecyclerView)findViewById(R.id.userInvitation_list);
            ...
            protected void populateViewHolder(final CreatedEventViewHolder viewHolder, final Users model, int position) {
                ...
                viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(UserCreatedInvitations.this  , InAppInvitation.class);
